...
Open "Datafile.txt" for Input as F1
	...
	For i = 1 To NMEA_Messages
		...
		''''''''''''''''''''''''''''''''''''' QC & Record Winds'''''''''''''''''''''''''''''''''
		If MsgID = "WIMDA" Then
			Input F1, MsgID, PRESIN, Q1, PRESMB, Q2, TEMPC, Q3, NG, NG, RH, NG, NG, NG, DIRT, Q4, DIRM, Q5, SPDN, Q6, SPDM, Cksum
			
			' Don't understand why variables re-defined here.
            dRH = RH 'relative humidity			
			...
			dPRES = dPRES * 1000
			  ...
			  'Set the #6 output to RELATIVE HUMIDITY and set the quality
			     SetOutputName 6, "RH"
			     SetOutputData 6, dRH
			     SetOutputUnits 6, "%"
		...
		Else
			...
			''''''''''''''''''''''''''''''''''''' QC & Record GPS''''''''''''''''''''''''''''''''		
			  ...
			  'Set the #6 output to Longitude
			     SetOutputName 7, "Lat"
			     SetOutputData 7, GGA_lat
			     SetOutputUnits 7, "min"
			
			  'Set the #7 output to Latitude
			     SetOutputName 8, "Long"
			     SetOutputData 8, GGA_long
			     SetOutputUnits 8, "min"
